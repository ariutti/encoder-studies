class Graph
{
  ...
  int min, max; // y range of the graph
  
  // CONSTRUCTOR ///////////////////////////////////////////////////////////////////
  Graph(float _x, float _y, float _w, float _h, int _K, int _min, int _max)
  {
    x = _x;
    y = _y;
    w = _w;
  ...
  void display()
  {
    ...
    { 
      ...
      float vMapped = map(v, min, max, h, 0);
